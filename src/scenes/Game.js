import { MouseContainer } from "../gameObjects/mouseContainer.js";
...
export default class Game extends Phaser.Scene{
    ...
    create(){
        ...
        this.anims.create({
            key: 'mouse-up',
            frames: this.anims.generateFrameNumbers('mouse-sprites', { start: 0, end: 5 }),
            frameRate: 5,
        });
        this.anims.create({
            key: 'mouse-down',
            frames: this.anims.generateFrameNumbers('mouse-sprites', { start: 5, end: 0 }),
            frameRate: 5
        });
        this.anims.create({
            key: 'mouse-angry',
            frames: this.anims.generateFrameNumbers('mouse-sprites', { frames: [11, 10, 9, 8, 7, 1, 0] }),
            frameRate: 5
        });
        this.anims.create({
            key: 'mouse-dizzy',
            frames: this.anims.generateFrameNumbers('mouse-sprites', { frames: [36, 37, 38, 1, 0] }),
            frameRate: 5,
        });
        ...
        for(let i = 0; i<this.mouseCount; ++i){
            ...
            const cIndex = i % 3;
            this.add.existing(new MouseContainer(
                this, 
                cIndex * size + left, 
        ...
        const text = this.add.text(20, 20, 
            ...
            { color: 'black', wordWrap: {width: boardWidth - 30} }).setOrigin(0);
        this.add.container( boardLeft, 30, [board, text]);
        this.timeText = this.add.text(0, 0, 'Time: 60s', { color: 'black', fontSize: 25 });
        this.timeStart();
    }
